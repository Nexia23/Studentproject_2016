    ...
    def calc_cval(self,step, C_t):
        ...
        for i in range(len(self.C_i)):
            ...
            for j in range(len(self.C_i)):  # nachbarzellen_c aufaddieren
                ...
                if self.c_ary[j].name == 'toxic' or self.c_ary[j].name == 'dead':           #produce nothing so no calculation
                    continue
            ...
            if self.c_ary[i].name == 'toxic':     #have their default c
                c_value = conz_i
            if self.c_ary[i].name == 'dead':  # have their default c
                c_value = 1
            self.C_i[i] = c_value
